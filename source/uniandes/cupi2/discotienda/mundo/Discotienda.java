...
public class Discotienda
{
    ...
    /*
     * Generar reporte de todos los discos de un género ROCK y POP- No supere los 1000 pesos
     * @throws fileNotFoundException 
     */
    public void generarReporteDiscosEconomicos()throws FileNotFoundException {
		File archivo =  new File("./data/discosCaros.txt");
		PrintWriter pluma = new PrintWriter(archivo);
		int numeroDiscosCaros = 0;
		pluma.println("Discos economicos");
		pluma.println("=========");
		...
		for(int i =0; i<discos.size();i++) {
			...
			if(miDisco.darGenero().equals("Pop") || miDisco.darGenero().equals("Rock")) {
				if(miDisco.darPrecioDisco()<=1000) {
					pluma.println("El disco es: "+miDisco.darNombreDisco()+
							"  El artista es: "+miDisco.darArtista()+
							"  El nombre de las canciones es: "+miDisco.darNombresCanciones()+
							"  El genero es de: "+miDisco.darGenero()+
							"  y El precio es de: "+miDisco.darPrecioDisco()+
						"");
					numeroDiscosCaros++;
				}
			}
		}
		if(numeroDiscosCaros==0) {
			throw new FileNotFoundException("No se encontaron discos caros");
		}
		pluma.close();
	}
 ...
 */
     ...
     */
     ...
     {
         // crear el archivo con la clase FILE, esta clse se puede utilizar para leer, escribir y manipular archivos.
         File archivoReporte= new File("./data/reporteDiscos.txt");

         //crear la pluma para escribir el archivo, la clase PrintWriter utiliza para escribir texto formateado en un archivo o en la consola. 
         PrintWriter lapiz=new PrintWriter(archivoReporte);

         //escribir con la lapiz en el archivo
         lapiz.println("Reporte de discos");
         lapiz.println("======================");
         ...
         for (int i = 0; i < discos.size(); i++) {
             ...
             //escribir con la lapiz la informacion requerida 
             lapiz.println("Nombre: "+ miDisco.darNombreDisco()+"      Artista: "+miDisco.darArtista()+"       Genero: "+miDisco.darGenero()+"      precio:"+miDisco.darPrecioDisco());
    ...
    public String metodo1( )
	{
		try {
			...
			return "Se genero el reporte satisfactoriamente";
		} 
	...
	{
		try {
			generarReporteDiscosEconomicos();
			return "Se genero el reporte satisfactoriamente";
		} 
		catch (FileNotFoundException e) {
